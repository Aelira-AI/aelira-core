...
class TestVeraPDFValidator:
    ...
    def test_custom_flavour(self):
        ...
        validator = VeraPDFValidator(base_url="http://localhost:8080", flavour="ua2")
    ...
    def test_validate_timeout(self, mock_httpx, dummy_pdf_path):
        ...
        mock_httpx.post.side_effect = real_httpx.TimeoutException("Request timed out")

        validator = VeraPDFValidator(base_url="http://localhost:8080", timeout=1.0)
...
class TestFeatureFlag:
    ...
    def test_feature_flag_enabled(self):
        ...
        with patch.dict(os.environ, {"VERAPDF_ENABLED": "true"}, clear=False):
            from src.config.settings import Settings
...
class TestPageExtraction:
    ...
    def test_extract_page_from_context(self):
        ...
        assert (
            validator._extract_page("root/document[0]/pages[99]/contentItem[3]") == 100
        )
