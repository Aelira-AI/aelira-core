"""
Integration tests for reporting new accessibility issue types
...
class TestIssueNormalization:
    """Test issue normalization for the extended issue types."""

    def test_new_issue_types_have_category_mapping(self):
        """Test that all the extended issue types have category mappings."""
        new_issue_types = [
            # PDF
            "reading_order",
            "table_header",
    ...
    def test_normalize_reading_order_issue(self):
        """Test normalizing a reading order issue."""
        issue = {
            "type": "reading_order",
            "severity": "high",
    ...
    def test_normalize_shadow_dom_issue(self):
        """Test normalizing a Shadow DOM issue."""
        issue = {
            "type": "image-alt",
            "impact": "critical",
    ...
    def test_normalize_conditional_format_issue(self):
        """Test normalizing a conditional formatting issue."""
        issue = {
    ...
    def test_normalize_pivot_table_issue(self):
        """Test normalizing a pivot table issue."""
        issue = {
            "type": "pivot_table",
            "severity": "medium",
    ...
    def test_normalize_animation_issue(self):
        """Test normalizing an animation issue."""
        issue = {
            "type": "animation",
            "severity": "medium",
    ...
    def test_normalize_smartart_issue(self):
        """Test normalizing a SmartArt issue."""
        issue = {
            "type": "smartart",
            "severity": "high",
    ...
    def test_normalize_embedded_object_issue(self):
        """Test normalizing an embedded object issue."""
        issue = {
