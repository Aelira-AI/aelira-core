...
from src.education.pdf_checks.pdfua_detector import PDFUADetector  # noqa: E402
from src.education.pdf_checks.models import PDFUAVersion  # noqa: E402
...
class TestPDFUAVersionDetection:
    ...
    def test_detect_untagged_pdf(self, temp_pdf_path):
        ...
        detector = PDFUADetector()
        result = detector.detect(temp_pdf_path)
