...
def mock_lti_launch_token():
    ...
    return {
        ...
        "https://purl.imsglobal.org/spec/lti/claim/target_link_uri": "https://api.example.com/lti/launch",
...
def mock_oidc_login_params():
    ...
    return {
        ...
        "target_link_uri": "https://api.example.com/lti/launch",
                ...
                "items": [
                    {
                        ...
                        "url": "https://api.example.com/lti/scan",
