"""
Tests for Improved Table Header Detection
...
class TestHeuristicHeaderDetection:
    ...
    @pytest.fixture
    def checker(self):
        """Create TableAccessibilityChecker instance for testing."""
        return TableAccessibilityChecker()

    def test_detect_headers_empty_cells(self, checker):
        """Test header detection with empty cell list."""
        result = checker._detect_table_headers_heuristic([])

        assert result.detected_headers == []
        assert result.detection_method == "none"
        assert result.confidence == 0.0

    def test_detect_headers_by_bold(self, checker):
        ...
        result = checker._detect_table_headers_heuristic(cells)
    ...
    def test_detect_headers_by_background(self, checker):
    ...
    def test_detect_headers_by_font_size(self, checker):
    ...
    def test_detect_headers_by_keywords(self, checker):
    ...
    def test_detect_headers_no_headers_found(self, checker):
    ...
    def test_detect_row_headers_by_bold_column(self, checker):
...
class TestGenerateTableFix:
    ...
    def test_generate_fix_for_column_headers(self, checker):
        ...
        fix = checker._generate_table_fix(table, header_detection)
    ...
    def test_generate_fix_for_row_headers(self, checker):
    ...
    def test_generate_fix_for_both_headers(self, checker):
    ...
    def test_generate_fix_no_headers_detected(self, checker):
    ...
    def test_generate_fix_priority_large_table(self, checker):
    ...
    def test_generate_fix_priority_low_confidence(self, checker):
...
class TestCreateTableFromRows:
    ...
    def test_create_table_empty_rows(self, checker):
        """Test creating table from empty rows."""
        result = checker._create_table_from_rows(1, 0, [])
        assert result is None

    def test_create_table_single_row(self, checker):
        """Test creating table from single row (should fail)."""
        rows = [
            (100.0, [{"text": "A", "bbox": (10, 100, 30, 120), "flags": 0, "size": 12}])
        ]
        result = checker._create_table_from_rows(1, 0, rows)
        assert result is None

    def test_create_table_valid_rows(self, checker):
        ...
        table = checker._create_table_from_rows(1, 0, rows)
...
class TestKeywordDetection:
    ...
    def test_common_header_keywords(self, checker):
    ...
    def test_partial_keyword_match(self, checker):
...
class TestEdgeCases:
    ...
    def test_table_with_empty_cells(self, checker):
    ...
    def test_single_column_table(self, checker):
    ...
    def test_single_row_table(self, checker):
    ...
    def test_all_cells_bold(self, checker):
