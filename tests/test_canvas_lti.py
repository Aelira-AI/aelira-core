...
def mock_canvas_oauth_config():
    ...
    return {
        ...
        "redirect_uri": "https://api.aelira.ai/canvas/oauth/callback",
...
class TestCanvasRemediation:
    ...
    def test_remediate_not_connected(
        self, client, auth_headers, override_deps
    ):
...
class TestCanvasOAuthCallback:
    ...
    def test_callback_success(
        self, mock_token_manager, mock_oauth_service, mock_api_client_cls, client, mock_session
    ):
