...
def test_v095_quarantine_is_single_head_after_v094_invariants():
    ...
    assert scripts.get_revision(HEAD).down_revision == PROVIDER_CONFIGURATION_HEAD
    assert (
        scripts.get_revision(PROVIDER_CONFIGURATION_HEAD).down_revision
