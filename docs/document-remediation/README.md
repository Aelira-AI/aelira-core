...
Choose a format guide: [PDF](pdf.md), [Office: DOCX, PPTX, XLSX](office.md), or [LaTeX](latex.md). Provider-neutral semantic guides cover [commutative diagrams](commutative-diagrams.md), [chemical formulas](chemical-formulas.md), and [molecular graphs](molecular-graphs.md). The chemical-formula guide documents the purpose-bound formula PDF specialist; the molecular-graph guide documents the chemical-structure specialist and its exact abbreviation vocabulary. Both cover saved-file verification and the mandatory human approval boundary. The [handwritten-math suitability corpus](handwritten-math.md) guide documents the corresponding frozen HMER path.
...
| Chemical formula semantics | [typed parser, speech, and MathML contract](../../src/education/chemical_formula.py) | [contract, corpus, identity, and refusal tests](../../tests/test_chemical_formula.py) |
| Molecular graph semantics | [typed graph, topology, identity, and description contract](../../src/education/molecular_graph.py) | [contract, corpus, canonicalization, and refusal tests](../../tests/test_molecular_graph.py) |
