...
Questions? Contact support@example.com""",
    ...
    async def send_pilot_welcome(
        ...
        # Do NOT add promotional content (discounts, feature marketing) here.
        # MXRoute TOS prohibits marketing emails. Use a separate marketing
        # email provider for promotional campaigns.
        return await self.send_email(
            to_emails=[to_email],
...
WCAG 2.1 AA DEADLINE: April 26, 2027
Title II compliance deadline for universities.

Need help? Contact pilot@example.com
...
https://example.com""",
    ...
    async def send_waitlist_confirmation(
        ...
        NOTE: Marketing emails (welcome series, promotions) require a
        separate marketing email provider, not MXRoute.
...
Questions? Contact hello@example.com
