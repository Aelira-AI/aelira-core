...
can use to demonstrate WCAG 2.1 compliance status for audits and documentation.
...
class ComplianceCertificate:
    ...
    LEVELS = {
        "platinum": {
            ...
            "statement": "has demonstrated exceptional commitment to digital accessibility, meeting or exceeding all WCAG 2.1 Level AA requirements.",
        },
        "gold": {
            "min_score": 90,
            "name": "GOLD",
            ...
            "statement": "has demonstrated excellent commitment to digital accessibility, meeting WCAG 2.1 Level AA requirements.",
        },
        "silver": {
            "min_score": 80,
            "name": "SILVER",
            ...
            "statement": "has demonstrated good progress toward digital accessibility compliance with WCAG 2.1 Level AA standards.",
        },
        "bronze": {
            "min_score": 70,
            "name": "BRONZE",
            ...
            "statement": "has demonstrated commitment to improving digital accessibility and meeting basic WCAG 2.1 requirements.",
        },
    }
    ...
    def generate_certificate(
        ...
        has been scanned and verified against WCAG 2.1 Level AA accessibility standards
        as mandated by Title II of the Americans with Disabilities Act.
        Certificate verification: support@example.com
        </font>
        """
        story.append(
            Paragraph(
