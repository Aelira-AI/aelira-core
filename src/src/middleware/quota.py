...
async def check_quota(
    ...
    if pages_per_scan_limit > 0 and pages > pages_per_scan_limit:
        return QuotaResult(
            ...
            f"Ask your administrator to raise this workspace's limits.",
...
def check_feature_access(tier: str, feature: str) -> bool:
    ...
    Args:
        tier: The tier name ("individual" or "department")
    ...
    if not check_feature_access(tier, feature):
        ...
        raise HTTPException(
            ...
            detail={
                ...
                "feature": feature,
                "message": f"{display_name} is not enabled for this workspace ({tier}). "
