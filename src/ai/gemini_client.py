...
class GeminiClient:
    ...
    def __init__(self, enable_rag: bool = True):
        ...
        # confusing "model not found" on every provider error. Aelira's own VPS
        # runs Gemini-only on purpose: local models are slow on that hardware and
        # the disk is tight, which is a bootstrapping constraint, not a defect.
