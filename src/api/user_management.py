...
async def invite_user(
    ...
    try:
                ...
                if current_user_count + pending_invites >= max_users:
                    ...
                    raise HTTPException(
                        ...
                        detail={
                            ...
                            "message": f"User limit reached for {tier_name} tier ({max_users} users). Upgrade to add more users.",
        ...
        try:
            ...
            inviter_email = inviter.email if inviter else "admin@aelira.ai"

            # Build accept URL
            dashboard_url = (
                settings.dashboard_url
                if hasattr(settings, "dashboard_url")
                else "https://dashboard.aelira.ai"
            )
