...
from src.api.demo_routes import router as demo_router  # Public demo endpoints
...
app.include_router(demo_router)  # Public demo endpoints (IP-based rate limiting)
