...
if settings.enable_csrf:
    app.add_middleware(
        ...
        # The readable double-submit token may span sibling dashboard/API
        # hosts without widening the httpOnly session-cookie trust boundary.
        cookie_domain=(
            settings.csrf_cookie_domain if settings.env == "production" else None
        ),
