...
- gemini-3-flash-preview: 100% accuracy, 5.4s - BEST QUALITY (paid tier recommended)
...
async def add_provider(
    ...
    if api_key_obj and api_key_obj.department_id:
        ...
        if department and department.tier in ["trial", "pilot", "department", "university"]:
            ...
            if is_encryption_configured():
                try:
                    ...
                    encryption_warning = "API key could not be encrypted for persistent storage"
            else:
                encryption_warning = (
...
async def get_recommended_models(
    ...
    Paid tier users can upgrade to higher-accuracy models via:
    ...
    return {
        "gemini": {
            "recommended_for_accuracy": {
                ...
                "best_for": ["paid_tiers", "critical_compliance"],
            },
...
async def get_byok_status(
    ...
    return {
        ...
        "configured_at": department.byok_configured_at.isoformat() if department.byok_configured_at else None,
