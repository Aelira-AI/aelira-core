...
async def scan_pdf(
    ...
    # Check quota before processing (individual_free tier has limits)
...
async def convert_latex_document(
    ...
    NOW STORES RESULTS IN DATABASE! ✅
    REQUIRES API KEY IN PRODUCTION 🔒
    REQUIRES: latex feature (not available on individual_free tier)
    """
    _, user_id, department_id = api_key_info

    # Check feature access - LaTeX requires individual_plus or higher
