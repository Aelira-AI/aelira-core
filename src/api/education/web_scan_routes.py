...
async def scan_website(
    ...
    REQUIRES: website feature (not available on individual_free or individual_plus tiers)
    ...
    # Check feature access - Website scanning requires individual_pro or higher
...
def process_sitemap_scan_background(
    ...
    try:
        ...
        validate_url_not_private(sitemap_url)
...
async def scan_code(
    ...
    # Check feature access - Code scanning requires website feature (individual_pro or higher)
