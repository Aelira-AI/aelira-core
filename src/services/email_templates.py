                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="background-color: #7C3AED; background: linear-gradient(135deg, #8B5CF6 0%, #6366F1 50%, #3B82F6 100%); padding: 32px; text-align: center;">
                            <a href="https://aelira.ai" style="text-decoration: none;">
                                <img src="https://api.aelira.ai/static/logo.png" alt="Aelira" width="180" style="display: inline-block; max-width: 180px; height: auto; margin-bottom: 12px;" />
                            </a>
                    ...
                    <tr>
                        <td style="background-color: #1f2937; padding: 24px 40px; text-align: center;">
                            <p style="margin: 0 0 12px 0; font-size: 12px; color: #9ca3af;">
                                {unsubscribe_link}<a href="https://aelira.ai/privacy" style="color: #9ca3af; text-decoration: underline;">Privacy Policy</a> |
                                <a href="mailto:support@aelira.ai" style="color: #9ca3af; text-decoration: underline;">Support</a>
                            </p>
...
def wrap_campaign_content(
    ...
    if content_lower.startswith("<!doctype") or content_lower.startswith("<html"):
        ...
        if "unsubscribe" not in html_content.lower():
            ...
            footer = (
                ...
                '<a href="https://aelira.ai/privacy" style="color: #6b7280; text-decoration: underline;">Privacy Policy</a>'
                "</div>"
            )
            html_content = re.sub(
                r"(</body>)",
    ...
    if wrapped_plain and "unsubscribe" not in wrapped_plain.lower():
        wrapped_plain += (
            f"\n\n---\nUnsubscribe: {unsub}\nPrivacy: https://aelira.ai/privacy\n"
        )
...
def get_email_footer(unsubscribe_url: Optional[str] = None) -> str:
    ...
    return f"""
        ...
        <p style="color: #9ca3af; font-size: 12px; text-align: center; margin: 0;">
            ...
            {unsubscribe_section}
            <a href="https://aelira.ai/privacy" style="color: #9ca3af; text-decoration: underline;">Privacy Policy</a>
        </p>
    ...
    content = f"""
            ...
            <div style="background-color: {COLOR_ERROR_BG}; border-left: 4px solid {COLOR_ERROR}; border-radius: 0 8px 8px 0; padding: 12px 16px; margin: 0;">
                <p style="margin: 0; font-size: 14px; color: {COLOR_ERROR_DARK};">
                    <strong>Reminder:</strong> WCAG 2.1 compliance deadline is April 24, 2026.
                </p>
            </div>
    """
    return get_email_wrapper(content, unsubscribe_url)
...
def render_remediation_failure_email(
    ...
    content = f"""
            ...
            <p style="color: #666; font-size: 14px; margin: 0;">
                Need help? Contact us at <a href="mailto:support@aelira.ai" style="color: {BRAND_PRIMARY};">support@aelira.ai</a>
            </p>
    """
    return get_email_wrapper(content, unsubscribe_url)
...
def render_department_trial_welcome_email(
    ...
    content = f"""
            ...
            <p style="color: #666; font-size: 14px; margin: 0;">
                Questions? Reply to this email or contact us at support@aelira.ai.
            </p>
    """
    return get_email_wrapper(content, unsubscribe_url)
...
def render_payment_failed_email(
    ...
    content = f"""
            ...
            <p style="color: #666; font-size: 14px; margin: 0;">
                Need help? Contact us at support@aelira.ai.
            </p>
    """
    return get_email_wrapper(content, unsubscribe_url)
...
def render_welcome_individual_email(
    ...
    content = f"""
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin: 0 0 24px 0;">
                <tr>
                    <td style="padding: 12px 0; vertical-align: top;">
                        ...
                        <strong>Log in to Dashboard:</strong> Go to dashboard.aelira.ai and paste your API key
                    </td>
                </tr>
                <tr>
                    <td style="padding: 12px 0; vertical-align: top;">
            ...
            <p style="color: #666; font-size: 14px; text-align: center; margin: 0;">
                ...
                <a href="https://aelira.ai/for-faculty" style="color: {BRAND_PRIMARY};">View upgrade options →</a>
            </p>
    """
    return get_email_wrapper(content, unsubscribe_url)
    ...
    content = f"""
            ...
            <div style="background-color: {COLOR_ERROR_BG}; border-left: 4px solid {COLOR_ERROR}; border-radius: 0 8px 8px 0; padding: 16px; margin: 0 0 32px 0;">
                ...
                <p style="margin: 0; font-size: 14px; color: #7f1d1d;">
                    April 24, 2026 - Title II compliance deadline for universities
                </p>
            </div>
            ...
            <div style="background-color: #f9fafb; border-radius: 8px; padding: 20px;">
                ...
                <p style="margin: 0 0 8px 0; font-size: 14px; color: #4b5563;">
                    <strong>Support:</strong> <a href="mailto:pilot@aelira.ai" style="color: {BRAND_SECONDARY}; text-decoration: none;">pilot@aelira.ai</a>
                </p>
                <p style="margin: 0; font-size: 14px; color: #4b5563;">
                    <strong>Documentation:</strong> <a href="https://aelira.ai/docs" style="color: {BRAND_SECONDARY}; text-decoration: none;">aelira.ai/docs</a>
                </p>
            </div>
    """
    return get_email_wrapper(content, unsubscribe_url)
...
def render_waitlist_confirmation_email(
    ...
    content = f"""
            ...
            <p style="margin: 0; font-size: 14px; color: #9ca3af; text-align: center;">
                Questions? Reply to this email or contact <a href="mailto:hello@aelira.ai" style="color: {BRAND_SECONDARY};">hello@aelira.ai</a>
            </p>
    """
    return get_email_wrapper(content, unsubscribe_url)
...
def render_deadline_reminder_email(
    ...
    Marketing email reminding about the April 2026 compliance deadline.

    Args:
        name: Recipient's name
        days_remaining: Days until April 24, 2026 deadline
        dashboard_url: URL to the dashboard
    ...
    content = f"""
            ...
            <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #4b5563;">
                The DOJ's Title II deadline for WCAG 2.1 AA compliance is <strong style="color: {urgency_color};">April 24, 2026</strong> — just <strong>{days_remaining} days away</strong>.
            </p>
            ...
            <p style="color: #666; font-size: 14px; text-align: center; margin: 0;">
                Questions? Reply to this email or contact <a href="mailto:support@aelira.ai" style="color: {BRAND_PRIMARY};">support@aelira.ai</a>
            </p>
    """
    return get_email_wrapper(content, unsubscribe_url)
...
def render_trial_nurture_day7_email(
    ...
    issues_fixed: int = 0,
    pricing_url: str = "https://aelira.ai/pricing",
    unsubscribe_url: Optional[str] = None,
) -> str:
    """
...
def render_waitlist_launch_email(
    name: str,
    signup_url: str = "https://aelira.ai/signup",
    unsubscribe_url: Optional[str] = None,
) -> str:
    """
...
def render_reengagement_email(
    ...
    content = f"""
            ...
            <div style="background-color: {COLOR_ERROR_BG}; border-left: 4px solid {COLOR_ERROR}; border-radius: 0 8px 8px 0; padding: 16px; margin: 0 0 24px 0;">
                <p style="margin: 0; font-size: 14px; color: {COLOR_ERROR_DARK};">
                    <strong>Reminder:</strong> The WCAG 2.1 compliance deadline is April 24, 2026. Don't fall behind!
                </p>
            </div>
    ...
    content = f"""
            ...
            <div style="background-color: {COLOR_INFO_BG}; border-left: 4px solid {COLOR_INFO}; border-radius: 0 8px 8px 0; padding: 16px; margin: 24px 0;">
                ...
                <p style="margin: 0; font-size: 13px; color: {COLOR_INFO_DARK};">
                    ...
                    <a href="mailto:hello@aelira.ai" style="color: {BRAND_SECONDARY};">hello@aelira.ai</a>.
                </p>
            </div>
...
Changed your mind? You can cancel the deletion within 30 days by contacting us at hello@aelira.ai.
