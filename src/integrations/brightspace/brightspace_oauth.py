...
def get_brightspace_authorization_url(
    ...
    # Brightspace OAuth authorization endpoint
    # Note: Brightspace uses /d2l/auth/oauth2/authorize path
    auth_url = f"{brightspace_instance_url.rstrip('/')}/d2l/auth/oauth2/authorize"
...
async def exchange_brightspace_code_for_token(
    ...
    # Brightspace OAuth token endpoint
    token_url = f"{brightspace_instance_url.rstrip('/')}/d2l/auth/oauth2/token"
