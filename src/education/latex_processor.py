"""
LaTeX to MathML Conversion Module (Enhanced Phase 4.1)
...
# =============================================================================
# Phase 4.1 Enhancements: Advanced LaTeX Support
# =============================================================================
...
# =============================================================================
# Siunitx SI Unit Support (Task 12)
# =============================================================================
...
class LaTeXEquation(BaseModel):
    ...
    content_type: LaTeXContentType = (
        LaTeXContentType.MATH
    )  # Phase 4.1: content classification
    position_start: int
    position_end: int
    line_number: Optional[int] = None
    detected_features: List[str] = []  # Phase 4.1: detected special features
...
class LaTeXProcessor:
    ...
    def __init__(self, use_ai: bool = True, progress_callback: callable = None):
        ...
        # Phase 4.1: Additional patterns for specialized content
    ...
    def _classify_content_type(self, latex: str) -> Tuple[LaTeXContentType, List[str]]:
        """
        Phase 4.1: Classify LaTeX content type and detect special features.
...
5. Do not include any preamble, just the description"""
    ...
    def _generate_heuristic_aria_label(
        ...
        Phase 4.1 Enhanced: Handles chemistry, physics, and diagram content.
        ...
        # Phase 4.1: Physics content (bra-ket, vectors)
    ...
    def _generate_siunitx_aria_label(self, latex: str) -> str:
        """
        Task 12: Generate ARIA label for siunitx SI unit expressions.
    ...
    def _generate_chemistry_aria_label(self, latex: str) -> str:
        """
        Phase 4.1: Generate ARIA label for chemistry content.
    ...
    def _generate_physics_aria_label(self, latex: str) -> str:
        """
        Phase 4.1: Generate ARIA label for physics notation.
    ...
    def _generate_diagram_aria_label(self, latex: str) -> str:
        """
        Phase 4.1: Generate ARIA label for TikZ diagrams.
...
def test_latex_processor():
    ...
    # Phase 4.1: Chemistry test cases
    ...
    print("=" * 60)
    print("Testing LaTeX to MathML conversion (Phase 4.1 Enhanced)")
    print("=" * 60)
    ...
    print("\n--- Phase 4.1: Chemistry (mhchem) ---\n")
    for name, latex_source in chemistry_test_cases:
        _test_single_equation(processor, name, latex_source)

    print("\n--- Phase 4.1: Physics (bra-ket, vectors) ---\n")
