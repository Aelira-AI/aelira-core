...
This module analyzes uploaded website code (HTML, CSS, JavaScript) for WCAG 2.1
...
2. Make it WCAG 2.1 Level AA compliant
...
- Focus should be visible and clear""",
        ...
        return guidance.get(
            rule, "Follow WCAG 2.1 Level AA guidelines for accessibility."
        )
