...
Generates professional, legal-ready PDF compliance reports for department
administrators to demonstrate WCAG 2.1 compliance for DOJ audits and the
DOJ ADA Title II compliance deadline (April 26, 2027 for large public
entities; extended from April 24, 2026 via DOJ Interim Final Rule
RIN 1190-AA82 effective April 20, 2026).
...
- ADA Title II deadline tracking with projections
...
class ComplianceReportGenerator:
    ...
    - DOJ ADA Title II deadline documentation (April 26, 2027 for large entities)
    ...
    async def generate_ai_recommendations(
        ...
        try:
            ...
            context_parts = [
                ...
                f"Days Until ADA Title II Deadline (April 26, 2027): {stats['april_2026_deadline']['days_remaining']}",
            ...
            prompt = f"""You are an accessibility compliance expert for higher education. Based on the following department data, provide 3-5 specific, actionable recommendations to improve WCAG 2.1 compliance before the DOJ ADA Title II deadline of April 26, 2027 (extended by one year from April 24, 2026 via DOJ Interim Final Rule RIN 1190-AA82, effective April 20, 2026). The extension applies to public entities in jurisdictions with population >= 50,000; smaller entities have until April 26, 2028. Despite the extension, rushed box-checking compliance will not satisfy auditors - recommend approaches that use the extra time for durable accessibility improvements.
...
Return ONLY valid JSON array, no other text."""
    ...
    def generate_department_report(
        ...
        • Days Until ADA Title II Deadline (April 26, 2027): <b>{deadline['days_remaining']} days</b><br/>
        ...
        # ==================== Deadline Tracking ====================
        story.append(Spacer(1, 0.3 * inch))
        story.append(Paragraph("ADA Title II Deadline Tracking", heading_style))

        deadline_text = f"""
        The U.S. Department of Justice has set <b>April 26, 2027</b> as the
        WCAG 2.1 Level AA compliance deadline for state and local public
        entities in jurisdictions with total population of 50,000 or more
        (including most public universities). Smaller public entities and
        special district governments have until <b>April 26, 2028</b>. These
        dates were extended by one year from April 24, 2026 / April 26, 2027
        under the DOJ Interim Final Rule <i>RIN 1190-AA82</i>, effective
        April 20, 2026 (Federal Register Vol. 91 No. 75).
        <br/><br/>
        ...
        <br/>For questions or support, contact support@example.com</i>
        """
        ...
        recommendations.append(
            {
                ...
                "description": f"With only {stats['april_2026_deadline']['days_remaining']} days until the ADA Title II deadline (April 26, 2027) "
