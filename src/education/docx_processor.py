...
class SmartArtIssue(BaseModel):
    """SmartArt accessibility issue (Task 6)."""
...
class EmbeddedObject(BaseModel):
    """Detected embedded object in DOCX (Task 7)."""
...
class EmbeddedObjectIssue(BaseModel):
    """Embedded object accessibility issue (Task 7)."""
...
class DocxProcessingResult(BaseModel):
    ...
    smartart_issues: List[SmartArtIssue] = []  # SmartArt accessibility issues (Task 6)
    embedded_object_issues: List[EmbeddedObjectIssue] = (
        []
    )  # Embedded object issues (Task 7)
...
class DocxProcessor:
    ...
    def process_docx(
        ...
        # Check SmartArt diagrams (Task 6)
        smartart_issues = self._detect_smartart(doc, file_path)

        # Check embedded objects (Task 7)
