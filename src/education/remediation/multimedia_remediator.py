...
class MultimediaRemediator(BaseRemediator):
    ...
    def _get_rule_based_fix(
        ...
        Returns a placeholder for fixable issues so the base flow
        continues to apply_fix() where the actual work happens.
        """
        if self.can_auto_fix(issue):
            return "generate"  # Placeholder — actual fix happens in apply_fix
        return None
