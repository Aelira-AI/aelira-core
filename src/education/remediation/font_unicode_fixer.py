...
ADOBE_GLYPH_LIST: Dict[str, int] = {
    ...
    "quotesingle": 0x0027, "parenleft": 0x0028, "parenright": 0x0029,
    "asterisk": 0x002A, "plus": 0x002B, "comma": 0x002C, "hyphen": 0x002D,
    "period": 0x002E, "slash": 0x002F, "colon": 0x003A, "semicolon": 0x003B,
    ...
    "perthousand": 0x2030, "trademark": 0x2122, "copyright": 0x00A9,
    "registered": 0x00AE, "degree": 0x00B0, "plusminus": 0x00B1,
    "mu": 0x00B5, "paragraph": 0x00B6, "sterling": 0x00A3,
    "yen": 0x00A5, "Euro": 0x20AC, "euro": 0x20AC,
    "section": 0x00A7, "acute": 0x00B4, "cedilla": 0x00B8,
    ...
    "Otilde": 0x00D5, "Odieresis": 0x00D6, "OE": 0x0152,
    ...
    "otilde": 0x00F5, "odieresis": 0x00F6, "oe": 0x0153,
...
class FontUnicodeFixer:
    ...
    def _process_font(self, font_obj) -> Optional[FontFixResult]:
        ...
        if differences:
            cmap_bytes, n_mappings = self._build_cmap_from_differences(differences, font_name)
    ...
    def _build_cmap_from_differences(
        self, differences, font_name: str
    ) -> tuple:
    ...
    def _generate_cmap(
        self, code_to_unicode: Dict[int, int], font_name: str
    ) -> bytes:
