        ...
        for fix in result.fixed_issues:
            db.add(
                ScanFix(
                    ...
                    location=getattr(fix, "location", None),
                    original_content=getattr(fix, "original_content", None),
                    fixed_content=getattr(fix, "fixed_content", None),
                    fix_method=getattr(fix, "fix_method", None),
