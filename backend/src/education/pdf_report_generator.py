    ...
    def _generate_wcag_criteria_chart(issues: List[Dict[str, Any]]) -> BytesIO:
        ...
        try:
            ...
            for issue in issues:
                ...
                # Extract just the number part (e.g., "1.1.1" from "WCAG 2.2 Level AA: 1.1.1 Non-text Content")
    ...
    def generate_website_report(scan_data: Dict[str, Any]) -> bytes:
        ...
        if not issues:
            no_issues_text = Paragraph(
                "✅ <b>No accessibility issues found!</b><br/>This website meets WCAG 2.2 Level AA standards.",
                ParagraphStyle(
                    "NoIssues",
        ...
        footer_text = Paragraph(
            "<b>Report generated by Aelira.ai</b><br/>Automated Accessibility Testing based on WCAG 2.2 Level AA Standards",
            ParagraphStyle(
                "Footer",
                parent=styles["Normal"],
                fontSize=9,
