...
class TestSSRF:
    ...
    def test_url_redirect_handling(self, client, auth_headers):
        """Test that URL redirects are handled safely."""
        # Test with a URL that would redirect to internal resource
        # This is hard to test without a controlled redirect server
