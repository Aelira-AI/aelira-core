...
class TestFixContentFallback:
    ...
    def test_heuristic_fallback_when_no_code_fix(self, heuristic_issue):
        ...
        assert fields["fixed_content"] == "Add a label element associated with the input"
...
class TestIssueIdGeneration:
    ...
    def test_same_issue_produces_same_id(self):
        issue = {"criterion": "1.1.1", "impact": "serious", "description": "Missing alt text"}
    ...
    def test_different_descriptions_produce_different_ids(self):
        issue_a = {"criterion": "1.1.1", "impact": "serious", "description": "Missing alt text"}
        issue_b = {"criterion": "1.1.1", "impact": "serious", "description": "Empty alt text"}
