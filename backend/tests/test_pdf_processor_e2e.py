...
class TestPDFBatchProcessing:
    ...
    def test_batch_directory_processing(self, batch_processor):
        ...
        assert len(results) == 5, f"Expected 5 PDFs processed, got {len(results)}"
...
class TestPDFReadingOrderVerification:
    """Test reading order verification for multi-column PDFs (Task 4)."""
    ...
    def test_verify_reading_order_returns_result(self, pdf_processor, sample_pdf):
        ...
        from src.education.pdf_processor import ReadingOrderResult

        result = pdf_processor.verify_reading_order(sample_pdf)
    ...
    def test_verify_reading_order_max_pages_limit(self, pdf_processor, sample_pdf):
        ...
        result = pdf_processor.verify_reading_order(sample_pdf, max_pages=1)
    ...
    def test_verify_reading_order_no_structure_tree(self, pdf_processor):
        ...
        with tempfile.NamedTemporaryFile(suffix=".pdf", delete=False) as f:
            ...
            result = pdf_processor.verify_reading_order(f.name)
    ...
    def test_visual_text_order_extraction(self, pdf_processor, sample_pdf):
        ...
        blocks = pdf_processor._get_visual_text_order(page)
    ...
    def test_multi_column_detection(self, pdf_processor):
        ...
        assert pdf_processor._detect_multi_column(single_column_blocks) is False
        ...
        assert pdf_processor._detect_multi_column(two_column_blocks) is True
    ...
    def test_reading_order_issue_model(self, pdf_processor):
        ...
        from src.education.pdf_processor import ReadingOrderIssue
    ...
    def test_reading_order_with_invalid_file(self, pdf_processor):
        ...
        result = pdf_processor.verify_reading_order("/nonexistent/file.pdf")
