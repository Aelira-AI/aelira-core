...
- pilot_gemini_approved: Manual override flag allowing a department to use the
  platform's shared Gemini key instead of configuring BYOK

BYOK is required for pilot and department tiers to control shared API costs.
"""
