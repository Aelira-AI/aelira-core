...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("FACULTY", "ADMIN", "SUPER_ADMIN", name="userrole"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "scan_type",
            sa.Enum("PDF", "POWERPOINT", "LATEX", "BATCH", name="scantype"),
            nullable=False,
        ),
        sa.Column(
            "status",
    ...
    op.create_index(
        "idx_scans_created_at", "scans", [sa.text("created_at DESC")], unique=False
    )
