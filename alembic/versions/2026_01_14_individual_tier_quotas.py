...
def upgrade() -> None:
    ...
    op.alter_column("departments", "scans_this_month", nullable=False, server_default="0")
    op.alter_column("departments", "pages_this_month", nullable=False, server_default="0")
