...
/** Blocks with artifacts (header, footer, page number) — used in isArtifact/getArtifactLabel tests below */
function makeBlocksWithArtifacts() { // eslint-disable-line no-unused-vars
  return [
