    ...
    {navigation.map((item) =>
      item.locked ? (
        <div
          ...
          title={`${item.name} requires a Pro plan`}
          aria-disabled="true"
        >
          ...
          <span className="ml-auto flex items-center gap-1">
            ...
            <span className="text-xs font-medium px-1.5 py-0.5 rounded" style={{ backgroundColor: 'var(--surface-accent-subtle)', color: 'var(--content-accent)' }}>Pro</span>
          </span>
        </div>
      ) : (
        <NavLink
