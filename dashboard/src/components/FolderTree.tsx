    ...
    <div className="folder-tree-container flex flex-col h-full">
      ...
      <div className="mb-4">
        ...
        <p className="text-sm" style={{ color: 'var(--content-secondary)' }}>
          Choose which folders from {providerName} you want to scan for accessibility issues.
        </p>
        <div
        ...
        >
          ...
          <span>
            Aelira only reads file metadata (names, types, sizes) from selected folders. Files are downloaded temporarily for scanning and deleted immediately after &mdash; no content is stored on our servers.
          </span>
        </div>
      </div>
