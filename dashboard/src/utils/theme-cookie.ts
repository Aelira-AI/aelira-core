 ...
 *
 * Shares the theme preference across subdomains of the deployment.
 ...
 * Returns the configured cookie domain for production, undefined for localhost
 */
function getCookieDomain(): string | undefined {
  ...
  // Set VITE_COOKIE_DOMAIN (e.g. .your-university.edu) to share the
  // preference across subdomains. Unset means host-only, which is correct
  // for localhost and for single-host deployments.
